...
const FuelFill = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setReportData({
        title: `Fuel Fill Report for ${formData.company}`,
  ...
  return (
    <>
    <Header />
    <div className="fuel-fill-container-full">
      <div className="fuel-fill-header-full">
        <h1>Fuel Fill Report</h1>
        <div className="date-display">
          Date: Aug 11, 2025 00:00 To Aug 18, 2025 23:59
        </div>
      </div>
      
      <div className="fuel-fill-content-full">
        {/* Left side - Form */}
