...
const FuelRemoval = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setReportData({
        title: `Fuel Removal Report for ${formData.company}`,
  ...
  return (
    <>
    <Header />
    <div className="fuel-removal-container-full">
      <div className="fuel-removal-header-full">
        <h1>Fuel Removal Report</h1>
        <div className="date-display">
          Date: Aug 11, 2025 00:00 To Aug 18, 2025 23:59
        </div>
      </div>
      
      <div className="fuel-removal-content-full">
        {/* Left side - Form */}
